...
:: Add rainmaker path
set ESP_RMAKER_PATH=C:/msys32/home/y.tan/esp-rainmaker
echo Setting ESP_RMAKER_PATH: %ESP_RMAKER_PATH%

:: Add homekit path
set HOMEKIT_PATH=C:/msys32/home/y.tan/esp-homekit-sdk
echo Setting HOMEKIT_PATH: %HOMEKIT_PATH%
