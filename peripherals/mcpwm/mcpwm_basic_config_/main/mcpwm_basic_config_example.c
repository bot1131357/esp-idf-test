...
static void gpio_test_signal(void *arg)
{
    ...
    while (1) {
        ...
        // static  int i = 0;
        // ++i;
        // if(i==1) printf("Set: 50Hz...\n");
        // else if(i<1000)
        // {
        //     //here the period of test signal is 20ms
        //     gpio_set_level(GPIO_NUM_12, 1); //Set high
        //     vTaskDelay(15/ portTICK_RATE_MS);             //delay of 10ms
        //     gpio_set_level(GPIO_NUM_12, 0); //Set low
        //     vTaskDelay(15/ portTICK_RATE_MS);         //delay of 10ms
        // }
        // else if(i==1000) printf("Set: 25Hz...\n");
        // else if(i<1500)
        // {
            
        //     //here the period of test signal is 20ms
        //     gpio_set_level(GPIO_NUM_12, 1); //Set high
        //     vTaskDelay(30/ portTICK_RATE_MS);             //delay of 10ms
        //     gpio_set_level(GPIO_NUM_12, 0); //Set low
        //     vTaskDelay(30/ portTICK_RATE_MS);         //delay of 10ms
        // }
        // else{
...
static void mcpwm_example_config(void *arg)
{
    ...
    mcpwm_deadtime_enable(MCPWM_UNIT_0, MCPWM_TIMER_0, MCPWM_ACTIVE_RED_FED_FROM_PWMXA, 10, 0);  //Enable deadtime on PWM0A and PWM0B with red = (656)*100ns & fed = (67)*100ns on PWM0A and PWM0B generated from PWM0A
