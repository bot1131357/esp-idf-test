...
### For Windows
`openssl s_server -WWW -key ca_key.pem -cert ca_cert.pem -port 8070` does not work.
We can use [secure_server.py](https://github.com/espressif/esp-idf/issues/5240#issuecomment-639292839). Need to update the key inside the script, and it should work accordingly.
